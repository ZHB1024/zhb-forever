...
public class LoginLogManagerImpl implements LoginLogManager {
    ...
    @Override
    public Page<LoginLogInfoData> getLoginLogInfoByUserNamePage(String userName, int start,
        int pageSize) {
        ...
        List<LoginLogInfoData> loginLogInfoDatas = loginLogDao
            .getLoginLogInfoByUserNamePage(userName, start, pageSize);
