...
/*login_info*/    
    ...
    public ForeverPage<FileInfoData> getFileInfoPage(List<ForeverCriteria> conditions){
        return foreverDao.getFileInfoPage(conditions);
    }
    
    public List<FileInfoData> getFileInfo(List<ForeverCriteria> conditions){
        return foreverDao.getFileInfo(conditions);
    }
	...
	@Override
	public void addFileInfoData(FileInfoData fileInfoData) {
		foreverDao.addFileInfoData(fileInfoData);
	}
