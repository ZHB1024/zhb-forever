...
public class VideoTest {
	...
	public static void main(String[] arg) {
		...
		dto.put("ffmpeg_path", "C:\\Users\\ZHB\\Videos\\ffmpeg.exe");// 必填
		dto.put("input_path", "C:\\Users\\ZHB\\Videos\\03权限传递.mp4");// 必填
		dto.put("video_converted_path", "C:\\Users\\ZHB\\Videos\\transfer\\gg.mp4");// 必填
		dto.put("logo", "C\\:/Users/ZHB/Videos/123.png");// 可选(注意windows下面的logo地址前面要写4个反斜杠,如果用浏览器里面调用servlet并传参只用两个,如
																// d:\\:/ffmpeg/input/logo.png)
		String secondsString = new VideoTest().videoTransfer(dto);
