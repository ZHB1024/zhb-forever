...
public class LoginController {
    ...
    public String login(HttpServletRequest request, HttpServletResponse response)
        ...
        UserInfoData userInfo = foreverManager
            .getLoginInfo(name, PasswordUtil.encrypt(name, password, PasswordUtil.getStaticSalt()));
        if (null == userInfo) {
    ...
    public void loginWithUrl(HttpServletRequest request, HttpServletResponse response)
    ...
    public String register(HttpServletRequest request, HttpServletResponse response,
        UserInfoData userInfoData, LoginInfoData loginInfoData) {
        ...
        loginInfoData.setPassword(PasswordUtil
            .encrypt(userInfoData.getName(), loginInfoData.getPassword(),
    ...
    public String initRoot(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (null != user) {
            ...
            user.setName("root");
            RoleInfoData roleInfoData = foreverManager
                .getRoleInfoByName(RoleTypeEnum.ADMIN.getName());
            ...
            loginInfo.setPassword(
                PasswordUtil.encrypt(user.getName(), "123456", PasswordUtil.getStaticSalt()));
